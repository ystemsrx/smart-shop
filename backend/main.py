...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["https://shop.bbbto.com", "http://localhost:3000", "https://chatapi.bbbto.com"],  # 生产环境应限制具体域名
            ...
            try:
                ...
                for k, v in scope.get('headers', []):
                    if k.decode().lower() == 'origin':
                        origin = v.decode()
                        break
                allowed = ["https://shop.bbbto.com", "http://localhost:3000", "https://chatapi.bbbto.com"]
...
_static_cors = CORSMiddleware(
    _static,
    allow_origins=["https://shop.bbbto.com", "http://localhost:3000"],
