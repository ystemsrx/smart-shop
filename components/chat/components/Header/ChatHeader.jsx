...
import { Check, ChevronDown, PanelLeft, PanelLeftClose } from "lucide-react";
        ...
        <div className="flex items-center">
          <div className="relative inline-block text-left model-selector-container select-none">
            ...
            >
              ...
              <ChevronDown className={`h-3.5 w-3.5 flex-shrink-0 transition-transform ${modelSelectorOpen ? "rotate-180" : "rotate-0"}`} />
            </button>
            ...
            <AnimatePresence>
              {modelSelectorOpen && (
                ...
                >
                  {models.map((model) => {
                    const modelLabel = `${model.name}${model.supports_thinking ? " · Reasoning" : ""}`;
                    ...
                    return (
                      <button
                        ...
                        className={`w-full flex items-center justify-between px-3 py-2 text-left hover:bg-gray-100 transition whitespace-nowrap ${isSelected ? "bg-gray-50" : ""}`}
                      >
