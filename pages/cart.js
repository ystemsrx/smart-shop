          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between items-center h-16">
              ...
              <div className="flex items-center space-x-4">
                ...
                <Link href="/shop" className="text-gray-700 hover:text-gray-900 px-3 py-2 rounded-md text-sm font-medium">
                  商品商城
                </Link>
                <Link href="/cart" className="bg-indigo-600 text-white px-3 py-2 rounded-md text-sm font-medium">购物车</Link>
